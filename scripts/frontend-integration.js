 ...
 * This file demonstrates how to integrate Forgeprism with a web frontend
 */

// For React/Vue/Angular applications
export class ForgeprismClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ForgeprismClient(provider, contractAddress);
